...
const EmployeeSchema = CollectionSchema(
  ...
  properties: {
    r'designation': PropertySchema(
      ...
      enumMap: _EmployeedesignationEnumValueMap,
    ),
...
void _employeeSerialize(
  ...
  writer.writeString(offsets[0], object.designation?.name);
...
Employee _employeeDeserialize(
  ...
  object.designation =
      _EmployeedesignationValueEnumMap[reader.readStringOrNull(offsets[0])];
  object.endDate = reader.readDateTimeOrNull(offsets[1]);
  object.id = id;
  object.name = reader.readStringOrNull(offsets[2]);
  object.startDate = reader.readDateTimeOrNull(offsets[3]);
  object.status =
      _EmployeestatusValueEnumMap[reader.readStringOrNull(offsets[4])];
...
P _employeeDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_EmployeedesignationValueEnumMap[reader.readStringOrNull(offset)])
          as P;
    case 1:
...
const _EmployeedesignationEnumValueMap = {
...
const _EmployeedesignationValueEnumMap = {
  r'productDesigner': Designation.productDesigner,
  r'flutterDeveloper': Designation.flutterDeveloper,
  r'qaTester': Designation.qaTester,
  r'productOwner': Designation.productOwner,
};
...
extension EmployeeQueryWhere on QueryBuilder<Employee, Employee, QWhereClause> {
  ...
  QueryBuilder<Employee, Employee, QAfterWhereClause> uuidEqualTo(String uuid) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterWhereClause> uuidNotEqualTo(
      String uuid) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension EmployeeQueryFilter
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> statusIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'status',
      ));
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> statusIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'status',
      ));
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'uuid',
        value: '',
  ...
  QueryBuilder<Employee, Employee, QAfterFilterCondition> uuidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'uuid',
        value: '',
...
extension EmployeeQuerySortBy on QueryBuilder<Employee, Employee, QSortBy> {
  ...
  QueryBuilder<Employee, Employee, QAfterSortBy> sortByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<Employee, Employee, QAfterSortBy> sortByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeQuerySortThenBy
  ...
  QueryBuilder<Employee, Employee, QAfterSortBy> thenByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<Employee, Employee, QAfterSortBy> thenByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.desc);
    });
  }
...
extension EmployeeQueryWhereDistinct
  ...
  QueryBuilder<Employee, Employee, QDistinct> distinctByUuid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeQueryProperty
  ...
  QueryBuilder<Employee, Designation?, QQueryOperations> designationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Employee, Status?, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'status');
    });
  }

  QueryBuilder<Employee, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
